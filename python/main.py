...
from gua_engine.rule_data import process_all_lines_wangshuai, process_all_lines_xunkong, process_all_lines_jin_tui_shen
...
def main():
    ...
    gua = process_all_lines_jin_tui_shen(gua)
